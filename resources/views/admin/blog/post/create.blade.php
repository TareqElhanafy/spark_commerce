          ...
          <div class="row mg-b-25">
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="title_en"  value="" placeholder="Enter post title">
                @error('title_en')
            ...
            <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="title_ar"  value="" placeholder="أدخل عنوان المنشور">
                  @error('title_ar')
                  <div class="alert alert-danger" role="alert">
                    {{$message}}
                     </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="col-lg-12">
                <div class="form-group" >
                  ...
                  <textarea name="details_en" class="form-control"id="summernote"  cols="30" rows="10"></textarea>
               @error('details_en')
                  <div class="alert alert-danger" role="alert">
                    {{$message}}
                     </div>
              ...
              <div class="col-lg-12">
                <div class="form-group" >
                  ...
                  <textarea name="details_ar" class="form-control"id="summernote1"  cols="30" rows="10"></textarea>
               @error('details_ar')
                  <div class="alert alert-danger" role="alert">
                    {{$message}}
                     </div>
