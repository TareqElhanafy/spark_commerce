...
<a href="{{ route('google','google') }}" class="btn btn-danger btn-block"><i class="fab fa-google"></i> Login with Google </a>
...
<div class="col-lg-5 offset-lg-1" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
     ...
     <form action="{{ route('register.post') }}" id="contact_form" method="post">
         @csrf
